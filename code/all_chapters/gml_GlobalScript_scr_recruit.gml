...
/// CODE
            ...
            {
                global.flag[global.monstertype[myself] + 600] = 1;
                scr_add_goal_array("recruits", ds_list_find_index(global.recruits_list, global.monstertype[myself]), 71);
                scr_add_goal_array("chapter_recruits", global.chapter - 2, 128);
