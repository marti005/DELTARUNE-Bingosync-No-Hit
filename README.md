...
This mod connects your game to [Bingosync](https://bingosync.com) and it can automatically mark goals from [this list](https://raw.githubusercontent.com/ners-xd/deltarune-bingosync/refs/heads/main/goal_list.json). You can also chat with other players, see the board update live and change your name color.
